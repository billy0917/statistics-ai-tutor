...
const i18n = {
    'zh-TW': {
        ...
        admin: {
            ...
            purgeAllData: '🧨 刪除所有資料',
            purgeAllDataTitle: '刪除所有資料',
            purgeAllDataWarning: '此操作會永久刪除所有用戶與學習紀錄，且無法復原。',
            purgeAllDataAck1: '我已完成必要備份並了解此操作無法復原。',
            purgeAllDataAck2: '我確定要清空本學期所有用戶與練習記錄。',
            purgeAllDataInputLabel: '請輸入 DELETE ALL 以確認',
            purgeAllDataInputPlaceholder: 'DELETE ALL',
            purgeAllDataCancelBtn: '取消',
            purgeAllDataConfirmBtn: '永久刪除',
            purgeAllDataFinalConfirm: '最後確認：確定要永久刪除所有用戶與學習資料嗎？',
            purgeAllDataSuccess: '已成功刪除所有資料。',
            purgeAllDataFailed: '刪除資料失敗，請稍後再試。',
            purgeAllDataLoading: '正在刪除資料，請稍候…',
            logoutBtn: '登出',
            backToHome: '返回首頁',
            systemOverview: '📊 系統總覽',
    ...
    'en': {
        ...
        admin: {
            ...
            purgeAllData: '🧨 Delete All Data',
            purgeAllDataTitle: 'Delete All Data',
            purgeAllDataWarning: 'This action permanently deletes all user and learning records and cannot be undone.',
            purgeAllDataAck1: 'I have completed required backups and understand this cannot be undone.',
            purgeAllDataAck2: 'I confirm I want to clear all users and practice records for this term.',
            purgeAllDataInputLabel: 'Type DELETE ALL to confirm',
            purgeAllDataInputPlaceholder: 'DELETE ALL',
            purgeAllDataCancelBtn: 'Cancel',
            purgeAllDataConfirmBtn: 'Delete Permanently',
            purgeAllDataFinalConfirm: 'Final check: permanently delete all user and learning data?',
            purgeAllDataSuccess: 'All data was deleted successfully.',
            purgeAllDataFailed: 'Failed to delete data. Please try again later.',
            purgeAllDataLoading: 'Deleting data, please wait…',
            logoutBtn: 'Logout',
